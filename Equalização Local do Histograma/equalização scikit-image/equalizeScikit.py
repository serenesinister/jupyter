...
tamanho_janela_2 = 9  # Janela 7x7

#equalização local utilizando skimage (equalização adaptativa)
imagem_eq_1 = equalize_adapthist(imagem, clip_limit=0.03, kernel_size=(tamanho_janela_1, tamanho_janela_1))
imagem_eq_2 = equalize_adapthist(imagem, clip_limit=0.03, kernel_size=(tamanho_janela_2, tamanho_janela_2))

#converter para uint8 salvar como imagem
imagem_eq_1 = (imagem_eq_1 * 255).astype('uint8')
imagem_eq_2 = (imagem_eq_2 * 255).astype('uint8')
...
#realizar OCR nas imagens (criar PDFs com OCR)
