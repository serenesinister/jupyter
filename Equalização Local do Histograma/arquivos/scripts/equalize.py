...
#Função para ler conteúdo de um arquivo.txt
...
#Calcular similaridade entre texto original e textos extraídos
...
#Criar arquivo markdown com tabela de comparação
tabela_markdown = f"""
...
#Salvar tabela em arquivo Markdown
