...
# Realizar OCR nas imagens equalizadas (criação de PDFs com OCR)
...
# Verifique se o caminho do Poppler está correto
# Caso não esteja no PATH, forneça o caminho completo do `pdftotext`
# Exemplo: caminho do Poppler (se estiver instalado em "C:\\poppler")
poppler_path = r"C:\poppler\bin\pdftotext.exe"
