...
parametros_imagens = {
    "placa01.png": {"fator_highboost": 4, "sigma": 1.5},
    "placa02.png": {"fator_highboost": 6, "sigma": 2},
    "placa03.png": {"fator_highboost": 5, "sigma": 1.2},
    "placa04.png": {"fator_highboost": 4, "sigma": 1.7},
    "placa05.png": {"fator_highboost": 3, "sigma": 2},
}
...
for nome_arquivo in nomes_arquivos:
    ...
    if os.path.exists(caminho_arquivo):
        ...
        #obter os parâmetros específicos para a imagem atual
        parametros = parametros_imagens.get(nome_arquivo, {"fator_highboost": 4, "sigma": 1.5})  #valores padrão caso não tenha especificação
        
        #aplicar o filtro HighBoost
        imagem_highboost = aplicar_highboost(imagem_restaurada, parametros["fator_highboost"], sigma=parametros["sigma"])
